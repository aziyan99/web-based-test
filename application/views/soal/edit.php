                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="kelas" name="kelas">
                    <?php  foreach ($kelas as $data): ?>
                      <option value="<?= $data['id']; ?>" <?php if ($data['id'] == $soal['id_kelas']) echo 'selected'; ?> ><?= $data['nama_kelas'] ?></option>
                    <?php endforeach; ?>
                  </select>
                </div>
              </div>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="mata_pelajaran" name="mata_pelajaran">
                    <?php foreach ($mata_pelajaran as $data): ?>
                      <option value="<?= $data['id']; ?>" <?php if ($data['id'] == $soal['id_mata_pelajaran']) echo 'selected'; ?>  ><?= $data['nama_mapel'];  ?></option>
                    <?php endforeach; ?>
                  </select>
                </div>
              </div>
