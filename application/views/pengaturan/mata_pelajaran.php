...
<div class="row">
    ...
    <div class="box">
      <div class="box-header">
        ...
        <div class="pull-right box-tools">
            <a href="<?= base_url('pengaturan_sekolah'); ?>" class="btn btn-info btn-flat"><i class="fa fa-arrow-left"></i> Kembali</a>
        </div>
      </div>
      <div class="box-body">
  ...
  <div class="col-md-5 col-lg-5 col-sm-5">
    <form action="<?= base_url('pengaturan_sekolah/simpan_mapel'); ?>" method="post">
    <div class="box">
      <div class="box-header">
